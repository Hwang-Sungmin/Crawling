...
# 오피 : //*[@id="MB-main-header"]/aside[1]/section/ul/li[2]/a
# 건마 : //*[@id="MB-main-header"]/aside[1]/section/ul/li[3]/a
# 휴게텔 : //*[@id="MB-main-header"]/aside[1]/section/ul/li[4]/a
# 안마 : //*[@id="MB-main-header"]/aside[1]/section/ul/li[5]/a
# 술집 : //*[@id="MB-main-header"]/aside[1]/section/ul/li[6]/a
# 키방 : //*[@id="MB-main-header"]/aside[1]/section/ul/li[7]/a

driver.find_element_by_xpath('//*[@id="MB-main-header"]/aside[1]/section/ul/li[7]/a').click()
sleep(0.5)
...
driver.find_element_by_xpath('//*[@id="MB-main-header"]/aside[1]/section/ul/li[7]/ul/li[1]/div/div[2]/a').click()                                   
sleep(0.5)
